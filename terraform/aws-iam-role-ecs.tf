module "iam_assumable_role_custom_ecs_execution" {
  ...
  role_name         = "custom_ecs_execution_broosketa"
  create_role       = true
...
module "iam_policy_custom_ecs_execution" {
  ...
  name = "custom_ecs_execution_policy_broosketa"
...
module "iam_assumable_role_custom_ecs_register" {
  ...
  role_name         = "custom_ecs_register_broosketa"
  create_role       = true
  role_requires_mfa = false
...
module "iam_policy_custom_ecs_register" {
  ...
  name = "custom_ecr_register_policy_broosketa"
